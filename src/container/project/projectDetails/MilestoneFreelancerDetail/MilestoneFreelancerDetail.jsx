...
import MilestoneFreelancerDetailCard from "./MilestoneFreelancerDetailCard";

class MilestoneFreelancerDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default connect(mapStateToProps, mapDispatchProps)(MilestoneFreelancerDetail);
