...
import InOfficeFreelancerDetailCard from "./InOfficeFreelancerDetailCard";

class InOfficeFreelancerDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default connect(mapStateToProps, mapDispatchProps)(InOfficeFreelancerDetail);
