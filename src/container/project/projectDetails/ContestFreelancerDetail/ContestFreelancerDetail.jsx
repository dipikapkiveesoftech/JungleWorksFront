...
import ContestFreelancerDetailCard from "./ContestFreelancerDetailCard";

class ContestFreelancerDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default connect(mapStateToProps, mapDispatchProps)(ContestFreelancerDetail);
